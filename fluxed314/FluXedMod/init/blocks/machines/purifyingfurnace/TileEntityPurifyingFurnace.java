...
public class TileEntityPurifyingFurnace extends TileEntity implements IInventory, ITickable
{
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				BlockPurifyingFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		}if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = PurifyingFurnaceRecipes.getInstance().getPurifyingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1), (ItemStack)this.inventory.get(2));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = PurifyingFurnaceRecipes.getInstance().getPurifyingResult(input1, input2, input3);
			ItemStack output = (ItemStack)this.inventory.get(4);
